...
module.exports = {
  ...
  SESSION_ID: process.env.SESSION_ID || 'Jarvis_470u_3z18_20wu_uwxz_x848_79uu_7y8w_185z',
  LANG: process.env.LANG || 'EN',
  AUTO_REACTION: process.env.AUTO_REACTION || 'falae',
  ...
  HEROKU_APP_NAME: process.env.HEROKU_APP_NAME || 'jarvis12',
